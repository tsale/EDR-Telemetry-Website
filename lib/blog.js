...
export function getSortedPostsData() {
    ...
    const allPostsData = fileNames.map((fileName) => {
        ...
        // Parse the post metadata section without pulling in vulnerable gray-matter/js-yaml.
        const matterResult = parseFrontMatter(fileContents);

        // Use frontmatter image if available, otherwise extract first image from content
