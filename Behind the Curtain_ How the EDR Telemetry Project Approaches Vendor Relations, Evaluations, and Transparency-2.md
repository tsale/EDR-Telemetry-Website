...
To make these validation paths clear, we are introducing a set of transparency indicators. Here’s how they work:

*   **What they look like:** Each vendor will have a small icon or banner next to their name on our platform.
*   **Where they are shown:** The indicator will be displayed prominently in the vendor’s header or on the main comparison table.
*   **What they mean:** Hovering over the indicator will reveal a tooltip with a concise summary of the validation path, such as:
...
Vendors do not have the ability to comment on or alter these indicators, as they are factual statements about the evaluation process.
...
We recognize that perfect transparency isn’t always possible. Not all vendors will grant full access, and not all contributors can publish their findings publicly. Our response is to:

*   Diligently document any limitations.
*   Make our validation paths visible and easy to understand.
*   Avoid making hidden assumptions.

## Why This Matters to You

For practitioners, our approach is designed to:

*   Reduce your reliance on vendor marketing claims.
*   Expose the boundaries and limitations of our evaluations.
*   Enable you to make informed trade-offs based on your specific needs.
*   Build long-term trust in the data we provide.

Our goal isn’t perfection. It’s **honesty about what we know and how we verified it**.
