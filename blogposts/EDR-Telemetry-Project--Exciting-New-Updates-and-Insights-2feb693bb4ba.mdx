...
*   [Provide a one-off donation](https://www.edr-telemetry.com/support#one-time) or
*   Sponsor the project.
...
The image is cropped for brevity. Full results [here](https://www.edr-telemetry.com/windows)
...
🔗 **Scores:** [https://www.edr-telemetry.com/scores](https://www.edr-telemetry.com/scores)
...
Our primary focus right now is to release the **Linux version**, which will feature multiple EDR vendors from the start. We’re putting in the effort to make this a reality **before the end of the year**! Follow project updates on the [About](https://www.edr-telemetry.com/about) page and [blog](https://www.edr-telemetry.com/blog).
