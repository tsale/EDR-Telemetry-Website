...
*   [Provide a one-off donation](https://www.edr-telemetry.com/sponsorship#one-time) or
*   Sponsor the project.
...
The next steps for the EDR Telemetry Project are highlighted in our [roadmap](https://www.edr-telemetry.com/roadmap). Our primary focus right now is to release the **Linux version**, which will feature multiple EDR vendors from the start. We’re putting in the effort to make this a reality **before the end of the year**!
