  ...
  public: {
    Tables: {
      ...
      macos_table_results: {
        ...
        Relationships: [
          {
            foreignKeyName: "macos_table_results_telemetry_id_fkey"
            columns: ["telemetry_id"]
            isOneToOne: false
            referencedRelation: "macos_telemetry"
            referencedColumns: ["id"]
          }
        ]
      }
...
export type MacosTelemetry = Database['public']['Tables']['macos_telemetry']['Row']
...
export type MacosScore = Database['public']['Tables']['macos_table_results']['Row']
...
export type MacosTelemetryInsert = Database['public']['Tables']['macos_telemetry']['Insert']
...
export type MacosScoreInsert = Database['public']['Tables']['macos_table_results']['Insert']
...
export interface MacosTelemetryWithScores extends MacosTelemetry {
  macos_table_results: MacosScore[]
}